...
\begin{equation}
\vcenter{\hbox{\includegraphics[height=3cm]{modifiedr1.eps}}} \quad = \quad \vcenter{\hbox{\includegraphics[height=3cm]{modifiedr1resolution.eps}}}\quad = \quad \vcenter{\hbox{\includegraphics[height=3cm]{modifiedr1b.eps}}}
\end{equation}
\begin{equation}
...
&\pic[2.5]{unknot.eps} = \left( 1 - \frac{v-v^{-1}}{s-s^{-1}} \right) \pic[2.5]{empty.eps}.
\end{align}
