...
The algebra $\cd(T^2)$ is generated by the elements $\tilde{P}_{0,0}, \tilde{P}_{1,0}, \tilde{P}_{0,1}, \tilde{P}_{1,1}, \tilde{P}_{2,0}$.
\end{proposition}
\begin{proof}
Let's visualize and keep track of which $\tilde{P}_{n, m}$ we've generated by dots on a lattice. So, we start with the configuration below.
...
\[
    \tilde{P}_{1,-1} = \{ 1 \}^{-1} \Big( [\tilde{P}_{1,0}, D_{0,1}] + \{ 1 \}^{-1} D_{1,1} \Big).
\]
...
\end{align*}
thus generating $\tilde{P}_{n, 1-n}, \tilde{P}_{n, 2-n}$ for all $n \in \Z$.
