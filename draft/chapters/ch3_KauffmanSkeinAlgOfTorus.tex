...
This chapter includes many, but not all of the details from the paper \cite{MPS20} which is co-authored by Hugh Morton, Peter Samuelson, and myself. The proofs included in this chapter are the proofs from \cite{MPS20} that either I wrote or contributed significantly to.
